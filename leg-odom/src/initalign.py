...
from DATA_READING_types_1 import IMU, RobotSensor, Paras
from DATA_PROCESSION_ekf import EKF
from tqdm import tqdm
from TOOLS_math_rot import euler2cbn
...
def initStaticAlignment(
    ...
    print("Abs. Foot Pos.: ", footpos_in_body)
    print("Foot Attitude: ", ekf.pvacur_.att.euler)
